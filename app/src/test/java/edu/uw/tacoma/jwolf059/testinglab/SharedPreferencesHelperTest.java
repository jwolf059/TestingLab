...
/**
 * Unit tests for the {@link SharedPreferenceHelper} that
...
public class SharedPreferencesHelperTest {
    ...
    private SharedPreferenceHelper mMockSharedPreferencesHelper;

    private SharedPreferenceHelper mMockBrokenSharedPreferencesHelper;
    ...
    private SharedPreferenceHelper createMockSharedPreference() {
        ...
        // correctly.
        when(mMockSharedPreferences.getBoolean(eq(SharedPreferenceHelper.KEY_LOGGED_IN), anyBoolean()))
                .thenReturn(mSharedPreferenceEntry.isLoggedIn());
        when(mMockSharedPreferences.getString(eq(SharedPreferenceHelper.KEY_EMAIL), anyString()))
        ...
        return new SharedPreferenceHelper(mMockSharedPreferences);
    }
    ...
    private SharedPreferenceHelper createBrokenMockSharedPreference() {
        ...
        return new SharedPreferenceHelper(mMockBrokenSharedPreferences);
    }
}
